...
## 简介
Spring Boot Easy Starter 是一个基于Spring Boot & MyBatis的快速启动项目，用于快速构建中小型Web项目，使我们摆脱那些重复劳动，专注于业务代码的编写，减少加班。



![tree](https://siasky.net/GAD9UivzbXRIEld4MyCaxNMS162aw1FR6HPRzPmvpVpp4w)


## 特征&提供
- 最佳实践的项目结构、配置文件、精简的POM（[查看项目结构图](https://siasky.net/GAD9UivzbXRIEld4MyCaxNMS162aw1FR6HPRzPmvpVpp4w)）
- 统一响应结果封装及生成工具
- 统一异常处理
- 简单的接口签名认证
- 常用基础方法抽象封装
